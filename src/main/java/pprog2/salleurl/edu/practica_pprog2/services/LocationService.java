package pprog2.salleurl.edu.practica_pprog2.services;
...
public class LocationService {
    /**
     * FoodLocal permission's request code.
     */
    ...
    /** Determines whether one FoodLocal reading is better than the current FoodLocal fix
     * @param location  The new FoodLocal that you want to evaluate
     * @param currentBestLocation  The current FoodLocal fix, to which you want to compare the new one
     */
